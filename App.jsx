...
const QUALITY_SIGNALS_DB = {
  ...
  "Twin Farms": { tier: "ultra_luxury", michelin_keys: 3, relais_chateaux: true, notes: "Barnard VT, all-inclusive, one of New England's finest" },
  "The Barn at Blackberry Farm": { tier: "ultra_luxury", michelin_keys: 3, notes: "Walland TN, modern sibling to Blackberry Farm" },
  "The Lodge at Blue Sky": { tier: "ultra_luxury", michelin_keys: 3, notes: "Wanship UT, Auberge Resorts, near Park City" },
  ...
  "Auberge du Soleil": { tier: "luxury", michelin_keys: 2, tl_gold: true, notes: "Rutherford CA, Napa Valley, Auberge Resorts" },
  "Meadowood Napa Valley": { tier: "luxury", michelin_keys: 2, relais_chateaux: true, notes: "St. Helena CA, independent, rebuilt after fire" },
  ...
  "The Langham Chicago": { tier: "luxury", michelin_keys: 2, notes: "River North Chicago, Langham Hotels" },
  ...
  "The Beverly Hills Hotel": { tier: "luxury", michelin_keys: 2, notes: "Beverly Hills CA, Dorchester Collection, Polo Lounge" },
  ...
  "Montage Healdsburg": { tier: "luxury", michelin_keys: 2, cn_hot_list: true, notes: "Healdsburg CA, Montage Hotels" },
  ...
  "Chatham Bars Inn": { tier: "luxury", michelin_keys: 1, notes: "Chatham MA, Cape Cod, independent" },
  ...
  "The Setai Miami Beach": { tier: "ultra_luxury", michelin_keys: 1, notes: "South Beach FL, independent" },
  ...
  "Park Hyatt Milan": { tier: "ultra_luxury", forbes_stars: 5, notes: "Via Tommaso Grossi Milan, World of Hyatt" },
  ...
  "The St. Regis Atlanta": { tier: "luxury", notes: "Buckhead Atlanta, Marriott Bonvoy" },
  "The St. Regis Houston": { tier: "luxury", notes: "River Oaks Houston, Marriott Bonvoy" },
  "The St. Regis Bal Harbour Resort": { tier: "ultra_luxury", notes: "Bal Harbour FL, Marriott Bonvoy" },
  ...
  "Four Seasons Hotel Washington DC": { tier: "luxury", notes: "Georgetown DC, independent" },
  ...
  "The Peninsula Hong Kong": { tier: "ultra_luxury", forbes_stars: 5, tl_gold: true, notes: "Tsim Sha Tsui Hong Kong, Peninsula Hotels" },
  "The Peninsula Tokyo": { tier: "ultra_luxury", forbes_stars: 5, notes: "Marunouchi Tokyo, Peninsula Hotels" },
  "The Peninsula Paris": { tier: "ultra_luxury", forbes_stars: 5, notes: "Avenue Kleber Paris, Peninsula Hotels" },
  ...
  "The Peninsula Bangkok": { tier: "ultra_luxury", forbes_stars: 5, notes: "Charoennakorn Bangkok, Peninsula Hotels" },

  // ── MANDARIN ORIENTAL ─────────────────────────────────────────────────────
  "Mandarin Oriental New York": { tier: "ultra_luxury", forbes_stars: 5, notes: "Columbus Circle NYC, Mandarin Oriental" },
  "Mandarin Oriental Boston": { tier: "ultra_luxury", notes: "Back Bay Boston, Mandarin Oriental" },
  ...
  "Mandarin Oriental Hong Kong": { tier: "ultra_luxury", forbes_stars: 5, tl_gold: true, notes: "Connaught Road Hong Kong, Mandarin Oriental" },
  "Mandarin Oriental Tokyo": { tier: "ultra_luxury", forbes_stars: 5, notes: "Nihonbashi Tokyo, Mandarin Oriental" },
  ...
  "Rosewood Sand Hill": { tier: "luxury", notes: "Menlo Park CA, Rosewood Hotels" },
  ...
  "The Beverly Hills Hotel": { tier: "luxury", cn_gold: true, notes: "Beverly Hills CA, Dorchester Collection, Polo Lounge" },
  ...
  "The Point": { tier: "ultra_luxury", cn_gold: true, relais_chateaux: true, notes: "Saranac Lake NY, Adirondacks, all-inclusive, independent" },
  ...
  "The Ranch at Laguna Beach": { tier: "luxury", tl_gold: true, forbes_stars: 5, notes: "Laguna Beach CA, canyon setting, independent" },

  // ── FORBES 5-STAR — ARIZONA ────────────────────────────────────────────────
  "Arizona Biltmore": { tier: "luxury", forbes_stars: 5, notes: "Phoenix AZ, Frank Lloyd Wright influenced, historic 1929, Marriott" },
  "The Global Ambassador": { tier: "luxury", forbes_stars: 5, notes: "Phoenix AZ, independent, newer luxury property" },
  "Royal Palms Resort and Spa": { tier: "luxury", forbes_stars: 5, notes: "Phoenix AZ, independent, Mediterranean villa style" },
  "Sheraton Grand at Wild Horse Pass": { tier: "luxury", forbes_stars: 5, notes: "Chandler AZ, Gila River tribal land, Marriott Bonvoy" },
  "JW Marriott Phoenix Desert Ridge": { tier: "luxury", forbes_stars: 5, notes: "Phoenix AZ, Marriott Bonvoy" },
  ...
  "The Phoenician": { tier: "luxury", forbes_stars: 5, notes: "Scottsdale AZ, Camelback Mountain, Luxury Collection/Marriott" },
  "JW Marriott Scottsdale Camelback Inn": { tier: "luxury", forbes_stars: 5, notes: "Scottsdale AZ, historic 1936, Marriott Bonvoy" },
  "Ambiente, A Landscape Hotel": { tier: "ultra_luxury", forbes_stars: 5, notes: "Jerome AZ, cantilevered suites over Verde Valley, independent" },
  "Enchantment Resort": { tier: "luxury", forbes_stars: 5, notes: "Sedona AZ, Boynton Canyon, independent" },
  "Mii amo": { tier: "ultra_luxury", forbes_stars: 5, notes: "Sedona AZ, all-inclusive destination spa within Enchantment, independent" },
  "L'Auberge de Sedona": { tier: "luxury", forbes_stars: 5, notes: "Sedona AZ, Oak Creek, independent" },
  "Hacienda del Sol Guest Ranch Resort": { tier: "luxury", forbes_stars: 5, notes: "Tucson AZ, historic 1929, independent" },
  ...
  "1 Hotel West Hollywood": { tier: "luxury", forbes_stars: 5, notes: "West Hollywood CA, SH Hotels" },
  "Beverly Wilshire": { tier: "ultra_luxury", forbes_stars: 5, notes: "Beverly Hills CA, Four Seasons, Pretty Woman hotel" },
  "Cameo Beverly Hills": { tier: "luxury", forbes_stars: 5, notes: "Beverly Hills CA, LXR Hotels/Hilton" },
  "Downtown LA Proper Hotel": { tier: "luxury", forbes_stars: 5, notes: "Downtown LA, independent" },
  "Fairmont Century Plaza": { tier: "luxury", forbes_stars: 5, notes: "Century City LA, Fairmont/Accor" },
  "Fairmont Miramar Hotel & Bungalows": { tier: "luxury", forbes_stars: 5, notes: "Santa Monica CA, Fairmont/Accor" },
  "Four Seasons Hotel Westlake Village": { tier: "luxury", forbes_stars: 5, notes: "Westlake Village CA, independent" },
  "The Georgian": { tier: "luxury", forbes_stars: 5, notes: "Santa Monica CA, independent" },
  "L'Ermitage Beverly Hills": { tier: "ultra_luxury", forbes_stars: 5, notes: "Beverly Hills CA, independent" },
  "The Maybourne Beverly Hills": { tier: "ultra_luxury", forbes_stars: 5, notes: "Beverly Hills CA, Maybourne Hotel Group" },
  "Oceana Santa Monica": { tier: "luxury", forbes_stars: 5, notes: "Santa Monica CA, LXR Hotels/Hilton" },
  "Regent Santa Monica Beach": { tier: "ultra_luxury", forbes_stars: 5, notes: "Santa Monica CA, IHG/Regent" },
  "Nobu Ryokan Malibu": { tier: "ultra_luxury", forbes_stars: 5, notes: "Malibu CA, Japanese-influenced, independent" },
  "The Langham Huntington Pasadena": { tier: "luxury", forbes_stars: 5, notes: "Pasadena CA, Langham Hotels" },
  "Dream Hollywood": { tier: "luxury", forbes_stars: 5, notes: "Hollywood CA, Dream Hotels" },
  "SLS Beverly Hills": { tier: "luxury", forbes_stars: 5, notes: "Beverly Hills CA, Luxury Collection/Marriott" },
  "Viceroy Santa Monica": { tier: "luxury", forbes_stars: 5, notes: "Santa Monica CA, Viceroy Hotels" },
  "W Hollywood": { tier: "luxury", forbes_stars: 5, notes: "Hollywood CA, Marriott Bonvoy" },
  "Fairmont Grand Del Mar": { tier: "ultra_luxury", forbes_stars: 5, notes: "Del Mar CA near San Diego, Fairmont/Accor" },
  "The Lodge at Torrey Pines": { tier: "luxury", forbes_stars: 5, notes: "La Jolla CA, craftsman style, independent" },
  "Pendry San Diego": { tier: "luxury", forbes_stars: 5, notes: "Gaslamp Quarter San Diego, Pendry/Marriott" },
  "Rancho Valencia Resort & Spa": { tier: "luxury", forbes_stars: 5, notes: "Rancho Santa Fe CA, independent" },
  "The US Grant": { tier: "luxury", forbes_stars: 5, notes: "Downtown San Diego, Luxury Collection/Marriott, historic 1910" },
  "Estancia La Jolla": { tier: "luxury", forbes_stars: 5, notes: "La Jolla CA, independent" },
  "Alila Marea Beach Resort Encinitas": { tier: "luxury", forbes_stars: 5, notes: "Encinitas CA, World of Hyatt" },
  "Parker Palm Springs": { tier: "luxury", forbes_stars: 5, notes: "Palm Springs CA, independent, Gene Autry's former estate" },
  "Kimpton Rowan Palm Springs": { tier: "luxury", forbes_stars: 5, notes: "Palm Springs CA, IHG/Kimpton" },
  "The Ritz-Carlton Rancho Mirage": { tier: "luxury", forbes_stars: 5, notes: "Rancho Mirage CA, desert canyon views, Marriott Bonvoy" },
  ...
  "Pendry Newport Beach": { tier: "luxury", forbes_stars: 5, notes: "Newport Beach CA, Pendry/Marriott" },
  "Balboa Bay Resort": { tier: "luxury", forbes_stars: 5, notes: "Newport Beach CA, independent" },
  "Casa del Mar": { tier: "luxury", forbes_stars: 5, michelin_keys: 1, notes: "Santa Monica CA, independent" },
  "Casa Palmero at Pebble Beach": { tier: "ultra_luxury", forbes_stars: 5, notes: "Pebble Beach CA, intimate cottage hotel, independent" },
  "The Inn at Spanish Bay": { tier: "luxury", forbes_stars: 5, notes: "Pebble Beach CA, links golf, independent" },
  "Monterey Plaza Hotel & Spa": { tier: "premium", forbes_stars: 5, notes: "Monterey CA, independent" },
  "The Cliffs Hotel and Spa": { tier: "luxury", forbes_stars: 5, notes: "Pismo Beach CA, independent" },
  "Alila Napa Valley": { tier: "luxury", forbes_stars: 5, notes: "St. Helena CA, World of Hyatt" },
  "Archer Hotel Napa": { tier: "luxury", forbes_stars: 5, notes: "Napa CA, independent" },
  "The Meritage Resort and Spa": { tier: "luxury", forbes_stars: 5, notes: "Napa CA, Marriott Bonvoy" },
  "Stanly Ranch": { tier: "ultra_luxury", forbes_stars: 5, notes: "Napa CA, Auberge Resorts" },
  "Vintage House at The Estate Yountville": { tier: "luxury", forbes_stars: 5, notes: "Yountville CA, independent" },
  "Single Thread Farms": { tier: "ultra_luxury", forbes_stars: 5, michelin_stars: 3, notes: "Healdsburg CA, inn above the Michelin 3-star restaurant, independent" },
  "MacArthur Place Hotel & Spa": { tier: "luxury", forbes_stars: 5, notes: "Sonoma CA, independent" },
  "Farmhouse Inn": { tier: "luxury", forbes_stars: 5, michelin_keys: 1, notes: "Forestville CA, Russian River Valley, independent" },
  "The Ritz-Carlton Lake Tahoe": { tier: "luxury", forbes_stars: 5, notes: "Truckee CA, ski-in/ski-out, Northstar, Marriott Bonvoy" },
  "Edgewood Tahoe": { tier: "luxury", forbes_stars: 5, notes: "Stateline NV, Lake Tahoe, independent" },
  "Chateau du Sureau": { tier: "ultra_luxury", forbes_stars: 5, relais_chateaux: true, notes: "Oakhurst CA, near Yosemite, French castle, independent" },
