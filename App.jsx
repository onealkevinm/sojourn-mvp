...
2. BEST POINTS REDEMPTION (#4CC97A) — Maximum cpp value from the stated program on its NATURAL component (airline miles → flights, hotel points → hotel). Never redirect airline miles to a hotel or hotel points to flights. In whyThis, spell out the redemption value clearly: "[X] miles used · estimated value $[Y] · [Z.Z] cents per mile — [excellent/strong/solid] value." For context: 2.0+ cents per mile = excellent, 1.4-2.0 = strong, below 1.4 = marginal. Call out if a cash option would beat the redemption value. redemption field must be non-null. redemptions array must include one entry with pointsUsed, dollarsValue, centsPerPoint, component.
...
6. FUTURE VALUE (#4C9AC9) — Strategic alternative: don't spend your miles on this trip at all. Pay cash, earn aggressively, and position for a bigger future redemption. In whyThis, make the case honestly: "Cash flights earn [X] miles via [card] + hotel earns [Y] [program] points = [Z] total miles earned. Hold your [balance] for [specific aspirational redemption this program is known for — e.g. Delta One to Tokyo, Hyatt Maldives]. This trip costs $[N] cash but leaves your balance intact." Tag label should be "Future Value" not "Best Points Earned". This option acknowledges the traveler's intent while offering a thoughtful strategic counterpoint — frame it as "if you want to save your miles for something bigger, here's how to play it."
