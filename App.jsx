...
const EXPERIENCE_SIGNALS_DB = {
  ...
  "Oahu": [
    ...
    { name: "North Shore", type: "outdoors", axis: ["local_authority", "trusted_authority"], notes: "Pipeline, Sunset Beach, Waimea Bay — world-class surf December-February, shrimp trucks, Turtle Bay, the authentic Hawaii that Waikiki isn't" },
  ...
  "Chicago": [
    ...
    { name: "Deep Dish Pizza", type: "experience", axis: ["trusted_authority", "populist"], notes: "Lou Malnati's is the local favorite, Pequod's has the caramelized crust, Giordano's for stuffed — allow 45+ min wait for the pizza, order ahead if possible" },
  ],
